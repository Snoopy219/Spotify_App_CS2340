...
/**
 * Class for handling non-async calls to Spotify API.
 */
public class SpotifyCalls {
    ...
    public static void getToken(Activity activity) {
        ...
        AuthorizationClient.openLoginActivity(activity,
                MainActivity.AUTH_TOKEN_REQUEST_CODE, request);
    }
    ...
    public static void getCode(Activity activity) {
        ...
        AuthorizationClient.openLoginActivity(activity,
                MainActivity.AUTH_CODE_REQUEST_CODE, request);
    }
    ...
    private static AuthorizationRequest getAuthenticationRequest(AuthorizationResponse.Type type) {
        return new AuthorizationRequest.Builder(MainActivity.CLIENT_ID,
                type, getRedirectUri().toString())
                .setShowDialog(false)
                .setScopes(new String[] { "user-read-email", "user-top-read", "user-read-private" })
